...
public class Util {
	...
	public static double sigmoidDeriv(double out) {
		return out * (1 - out);
	}
	  
	public static double getGradient(double output) {
		// This takes the "guess" and tells you how steep the hill is at that point
